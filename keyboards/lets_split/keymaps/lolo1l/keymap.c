...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_4x12(																					\
		...
		KC_ESC,	KC_LGUI,KC_MENU,KC_LALT,F2_BSPC,KC_SPC,		KC_LSFT,KC_FN1,	KC_DEL,	KC_INS,	KC_BSLS,KC_ENT		\
	),

	[1] = LAYOUT_ortho_4x12(																					\
		KC_PSCR,KC_F1,	KC_F2,	KC_F3,	KC_F4,	KC_F5,		KC_PGUP,KC_HOME,KC_UP,	KC_END,	KC_F11,	KC_EQL,		\
		_______,KC_F6,	KC_F7,	KC_F8,	KC_F9,	KC_F10,		KC_PGDN,KC_LEFT,KC_DOWN,KC_RGHT,KC_F12,	HK_LANG,	\
	...
	[3] = LAYOUT_ortho_4x12(																					\
		RESET,	RGB_MOD,RGB_VAI,RGB_HUI,RGB_SAI,KC_CAPS,	KC_WH_U,KC_BTN2,KC_MS_U,KC_BTN3,HCK_ON,	KC_PLUS,	\
		_______,RGB_TOG,RGB_VAD,RGB_HUD,RGB_SAD,KC_BTN1,	KC_WH_D,KC_MS_L,KC_MS_D,KC_MS_R,HCK_OFF,OT_RCTL,	\
		_______,KC_EXLM,KC_AT,	KC_HASH,KC_DLR,	KC_PERC,	KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_UNDS,	\
		_______,_______,_______,_______,_______,OT_RSFT,	_______,_______,OT_RALT,_______,OT_RGUI,_______		\
	)
